  ...
  render() {
    return (
      <div className={s.CrossFader_container} >
        {/* EQ/Volume Box */}
        <div className={s.CrossFader_Box} style={{ float: this.props.otherside }}>
          ...
          <div className={s.slider}>
            <Slider
              ...
              onChange={(newValue) => {
                ...
                if (this.props.name == 'CrossFaderA') {
                  this.props.changeVolumeA(newValue / 127);
                } else if (this.props.name == 'CrossFaderB') {
        ...
        {/* Gain/Filter Box */}
        <div className={s.CrossFader_Box} style={{ float: this.props.side, marginBottom: '2px' }}>
          <div className={s.knob}>
            <BiDirectionalKnob
        ...
        <div className={s.CrossFader_Box} style={{ float: this.props.side, width: '57px', margin: '2px 0' }}>
        ...
        {/* Key/ Pan Box */}
        <div className={s.CrossFader_Box} style={{ float: this.props.side, marginTop: '2px' }}>
          <div className={s.knob}>
            <BiDirectionalKnob
